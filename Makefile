...
sanxingdui-polished-tex:
	python scripts/ocr/markdown_to_sanxingdui_tex.py --polished

sanxingdui-polish-tmux:
	bash scripts/ocr/start_sanxingdui_polish_tmux.sh
