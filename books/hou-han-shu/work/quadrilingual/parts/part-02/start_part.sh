...
SESSION="${1:-zhjpbook-hou-han-shu-part-02-100-low}"
...
START_INDEX="4378" \
END_INDEX="8779" \
MANIFEST_OVERRIDE="books/hou-han-shu/work/quadrilingual/parts/part-02/manifest.json" \
WORK_ROOT_OVERRIDE="books/hou-han-shu/work/quadrilingual/parts/part-02/parallel-json" \
