...
SESSION="${1:-zhjpbook-hou-han-shu-part-03-100-low}"
...
START_INDEX="8780" \
END_INDEX="13152" \
MANIFEST_OVERRIDE="books/hou-han-shu/work/quadrilingual/parts/part-03/manifest.json" \
WORK_ROOT_OVERRIDE="books/hou-han-shu/work/quadrilingual/parts/part-03/parallel-json" \
