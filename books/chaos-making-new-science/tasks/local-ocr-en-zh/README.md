# Chaos: Making a New Science Local OCR EN/ZH Tasks

Use this manifest for the local Mathpix-parity OCR path. It does not replace the existing exact-TeX/Mathpix artifacts.

Required order:

1. Run `scripts/interlinear/run_textbook_local_ocr.py --book-id chaos-making-new-science --smoke` and inspect the output.
