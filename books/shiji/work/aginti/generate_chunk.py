...
def prompt_sentence(sentence_text, section_title, section_id,
    ...
    sysmsg = (
        ...
        "- Very short quoted speech, insults, and exclamations must still be translated into real Japanese. "
        "Do not copy a short Chinese utterance just because it is brief; for example 老女子！ should become "
        "老女め！ or 老いた女め！ in ja, with a modern Chinese paraphrase in zh_modern.\n"
