# Quantum Field Theory for the Gifted Amateur Local OCR EN/ZH Tasks

Use this manifest for the local Mathpix-parity OCR path. It does not replace the existing exact-TeX/Mathpix artifacts.

Required order:

1. Run `scripts/interlinear/run_textbook_local_ocr.py --book-id qft-gifted-amateur --smoke` and inspect the output.
