...
<p align="center">
  <a href="../assets/edition-comparisons/kokoro-jp-main-sentence-page-20.png">
    <img src="../assets/edition-comparisons/kokoro-jp-main-sentence-page-20.png" alt="こころの日本語本文一文、ふりがな、中国語注、ピンイン、文法色つき" width="100%">
  </a>
</p>
...
| `assets/edition-comparisons/` | PDF 本文ページから作る一文サンプルと四種類比較画像 |
