...
<p align="center">
  <a href="../assets/edition-comparisons/kokoro-jp-main-sentence-page-20.png">
    <img src="../assets/edition-comparisons/kokoro-jp-main-sentence-page-20.png" alt="《心》的日文主文单句示例，含假名、中文注释、拼音和语法颜色" width="100%">
  </a>
</p>
...
| `assets/edition-comparisons/` | 从 PDF 内页生成的单句示例和四版本对比图 |
