...
| P4 | `one-hundred-years-of-solitude` | One Hundred Years of Solitude / 百年孤独 / 百年の孤独 | `sources/one-hundred-years-of-solitude` | Prepared; 361 chunks, 0/361 generated | Strong first world-literature run: compact, famous, EN spine with published ZH reference. |
| P5 | `wuthering-heights` | Wuthering Heights / 呼啸山庄 / 嵐が丘 | `sources/wuthering-heights` | Prepared; 329 chunks, 0/329 generated | Moderate length, clear EN spine, ZH PDF reference. |
| P6 | `the-count-of-monte-cristo` | The Count of Monte Cristo / 基督山伯爵 / モンテ・クリスト伯 | `sources/the-count-of-monte-cristo` | Prepared; 1143 chunks, 0/1143 generated | Adventure novel with strong learner appeal; long but source structure is clear. |
| P7 | `notre-dame-de-paris` | Notre-Dame de Paris / 巴黎圣母院 / ノートルダム・ド・パリ | `sources/notre-dame-de-paris` | Prepared; 471 chunks, 0/471 generated | EN spine prepared; ZH PDF has no usable embedded text, so OCR or generated ZH is needed. |
| P8 | `les-miserables` | Les Misérables / 悲惨世界 / レ・ミゼラブル | `sources/les-miserables` | Prepared; 1630 chunks, 0/1630 generated | Very long; EN spine and ZH text reference prepared, best after shorter world-literature runs. |
| P9 | `silence` | 沉默 / Silence | `sources/Silence.epub` | English Markdown exists | Powerful story; needs JP/ZH source pairing strategy. |
| P10 | `temple-of-dawn` | 晓寺 / The Temple of Dawn | `sources/晓寺 - The Temple of Dawn` | Sources grouped | Continue Mishima sequence after Spring Snow. |
| P11 | `silent-cry` | 万延元年的足球队 / The Silent Cry | `sources/The Silent Cry` | Sources grouped | Major Oe work; high literary value. |
| P12 | `personal-matter` | 个人的体验 | `sources/个人的体验` | Sources grouped | Important Oe, likely manageable. |
| P13 | `heike` | 平家物语 / 平家物語 | `sources/平家物语` | Sources grouped | Epic and famous; harder than modern novels but attractive. |
| P14 | `pillow-book` | 枕草子 | `sources/枕草子` | Sources grouped | Classic prose; good after narrative-first queue. |
| P15 | `ginga-tetsudo` | 銀河鉄道の夜 | `sources/銀河鉄道の夜` | Prepared, 604 chunks | Short and beloved; good when we want a faster run. |
| P16 | `chumon-no-ooi-ryoriten` | 注文の多い料理店 | `sources/注文の多い料理店` | Prepared, 2698 chunks | Children’s stories; keep after stronger single-book priorities. |
