...
BOOKS: list[EnhancementBook] = [
    EnhancementBook("kokoro", "心 / こころ", "early_bilingual", "sources/kokoro", "phase-1-normal-english", priority=10),
    EnhancementBook("snow-country", "雪国", "early_bilingual", "sources/snow-country", "phase-1-normal-english", priority=20),
    EnhancementBook("no-longer-human", "人間失格", "early_bilingual", "sources/no-longer-human", "phase-1-normal-english", priority=30),
    EnhancementBook("rashomon-stories", "羅生門短篇集", "early_bilingual", "sources/罗生门", "phase-1-normal-english", priority=40),
    EnhancementBook("woman-in-the-dunes", "砂女 / 砂の女", "early_bilingual", "sources/砂女", "phase-1-normal-english", priority=50),
    EnhancementBook("kinkakuji", "金阁寺 / 金閣寺", "early_bilingual", "sources/金阁寺", "phase-1-normal-english", priority=60),
    EnhancementBook("izu-no-odori", "伊豆的舞女 / 伊豆の踊子", "early_bilingual", "sources/伊豆的舞女 - [日]川端康成.epub", "phase-1-normal-english", priority=70),
    EnhancementBook("the-old-capital", "古都", "early_bilingual", "sources/《古都》（川端康成经典名作，余华倾情推荐）.epub", "phase-1-normal-english", priority=80),
    EnhancementBook("genji-modern", "源氏物语 / 源氏物語", "early_bilingual_large", "sources/源氏物语", "phase-1-normal-english", priority=90),
    EnhancementBook(
        "shiji-aginti",
        "史記",
        "classical_chinese",
        ...
        add_modern_ja=True,
        priority=200,
        notes="Shiji chunks already contain zh_original and zh_modern; backfill English and readable modern Japanese from zh_modern without rewriting existing Japanese.",
    ),
    EnhancementBook(
        "sishu-jizhu-aginti",
        "四書章句集註",
    ...
    EnhancementBook(
        ...
        "sources/sishu",
        "later-legacy-sishu-preserved",
        add_modern_zh=True,
        add_modern_ja=True,
        priority=900,
        dependency="run_only_if_explicitly_requested",
        notes="Legacy Sishu pass is preserved as read-only input and is not part of the active Sishu backfill. Use the AgInTi Sishu version unless the user explicitly asks to spend quota on this legacy variant.",
    ),
    EnhancementBook(
