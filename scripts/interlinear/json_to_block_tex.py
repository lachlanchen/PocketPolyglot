...
def convert(data: dict[str, Any], *, color_mode: str = "color", cover_image: str = "") -> str:
    ...
    out.extend(
        [
            ...
            rf"\InterTitle{brace(render_tokens(data['title']['zh'], 'zhpy'))}{brace(render_tokens(data['title']['ja'], 'jpruby'))}{{{tex_escape(cover_image)}}}",
            "",
        ]
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = convert(data, color_mode=args.color_mode, cover_image=args.cover_image)
    if args.output:
