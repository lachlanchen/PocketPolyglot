...
usage() {
  cat <<'USAGE'
Usage: scripts/interlinear/start_classical_queue_tmux.sh [session]

Starts the classical quadrilingual queue immediately, independent of the
fantasy queue. It runs one classical book at a time:

  lunyu, mengzi, xunzi, mozi, hanfeizi, guiguzi, lushi-chunqiu,
  sunzi-bingfa, wuzi, sunbin-bingfa, simafa, weiliaozi
...
session="${1:-zhjpbook-classical-queue}"
